...
class MainPage(customtkinter.CTk):
    ...
    def init_inventory_page(self):
        ...
        self.invenAddLabel = customtkinter.CTkLabel(self.invenWidgetFrame, text="Inventory")
        self.invenAddLabel.grid(column=0, row=2, pady=10, padx=20, sticky="w")
        ...
        self.nameEntryLabel.grid(column=0, row=2, pady=10, padx=20,sticky="w")
